...
def python_data_stream_example():
    ...
    # в отличие от tumbling windows, здесь два параметра - длина окна и частота начала окна
    ds.window_all(SlidingProcessingTimeWindows.of(size=Time.seconds(20), slide=Time.seconds(5))) \
